...
const nextConfig: NextConfig = {
        ...
        headers: [
          {
            ...
            value: [
              ...
              "media-src 'self' https://*.amazonaws.com https://*.s3.amazonaws.com https://*.s3.us-east-1.amazonaws.com blob: data:",
              "font-src 'self' data:",
              "connect-src 'self' http://localhost:3001 http://localhost:3000 https://api.line.me https://*.line.me https://access.line.me https://*.line-scdn.net https://*.amazonaws.com https://registrar.kiddeelab.co.th https://kdl-backend.vercel.app https://*.vercel.app https://cloudflareinsights.com https://*.cloudflareinsights.com wss://*.line.me",
  ...
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: "https",
        hostname: "kdl-image.s3.us-east-1.amazonaws.com",
        port: "",
        pathname: "/**",
      },
      {
      ...
      {
        protocol: "https",
        hostname: "kiddee-lab-lms.s3.us-east-1.amazonaws.com",
        port: "",
        pathname: "/**",
      }
    ],
