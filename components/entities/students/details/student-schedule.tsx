...
import EditSchedule from "@/components/entities/schedule/dialogs/edit-schedule-dialog";
import ScheduleTable from "@/components/entities/schedule/tables/schedule-table";
