      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        <div className="flex flex-col text-sm mb-4">
          <div className="text-lg ">
            <span>Class:</span> {selectedCourse.title.split(" (")[0]}
          </div>
          <div className="text-lg ">
            <span>Time:</span> {selectedCourse.fullTime}
          </div>
          <div className="text-lg ">
            <span>Teacher:</span> {selectedCourse.teacher}
          </div>
          <div className="text-lg ">
            <span>Room:</span> {selectedCourse.room}
          </div>
        </div>
